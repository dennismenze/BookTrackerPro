...
from models import Book, UserBook, db, User, ReadingGoal, Author, List, BookList, Translation
...
admin.add_view(CustomModelView(Translation, db.session, endpoint='translations'))
...
def add_translation(table_name, row_id, column_name, language, content):
